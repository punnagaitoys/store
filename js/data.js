...
const SEED_PRODUCTS = [
  {
    ...
    description: 'Beautiful handcrafted wooden rainbow stacking toy that develops motor skills, color recognition, and creativity in young children. Made from sustainable wood with non-toxic paint.',
    price: 899,
    originalPrice: 1199,
    category: 'Educational & Learning',
    ageGroup: '0-2',
    imageUrl: 'https://images.unsplash.com/photo-1560785496-3c9d27877182?w=500',
    inStock: true,
    featured: true,
    badge: 'Best Seller'
  },
  {
    ...
    description: 'Classic LEGO set with 900+ pieces in various colors. Perfect for building anything your imagination can dream up. Includes building ideas booklet.',
    price: 1499,
    originalPrice: null,
  ...
  },
  {
    ...
    description: 'Mess-free creative fun! Draw, doodle and erase endlessly with this magnetic drawing board. Includes a magnetic pen and stamps. Perfect travel toy.',
    price: 549,
    originalPrice: 699,
  ...
  },
  {
    ...
    description: 'The classic word game adapted for younger players! Features two sides — one for beginners with pictures and one for advanced play. Develops vocabulary and spelling.',
    price: 799,
    originalPrice: null,
  ...
  },
  {
    ...
    description: 'High-speed remote control car with 4WD, LED lights, and shock-absorbing tires. Works on all terrain. Speeds up to 25 km/h. 2.4 GHz anti-interference technology.',
    price: 1299,
    originalPrice: 1799,
    category: 'Remote Control',
    ageGroup: '9-12',
    imageUrl: 'https://images.unsplash.com/photo-1546792557-bd04f6a3d5ce?w=500',
    inStock: true,
    featured: true,
    badge: 'Sale'
  },
  {
    ...
    description: 'Adorably soft and huggable teddy bear made from premium hypoallergenic materials. Perfect first toy for babies. Machine washable. Comes in a beautiful gift box.',
    price: 649,
    originalPrice: null,
  ...
  },
  {
    ...
    description: 'Indoor/outdoor mini basketball hoop with adjustable height from 3–6 feet. Includes 2 mini balls. Great for developing hand-eye coordination and keeping kids active.',
    price: 999,
    originalPrice: 1299,
  ...
  },
  {
    ...
    description: 'Beautiful fashion doll with 20+ outfit combinations, accessories, and furniture pieces. Encourages storytelling, creativity and imaginative play.',
    price: 1199,
    originalPrice: null,
    category: 'Dolls & Fashion',
    ageGroup: '6-8',
    imageUrl: 'https://images.unsplash.com/photo-1591729651662-185a7ef34999?w=500',
    inStock: false,
    featured: false,
    badge: 'Limited'
  }
